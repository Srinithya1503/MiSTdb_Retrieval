...
# Load the domain combinations from an Excel file
input_combinations_path = 'Unique_Domain_Combinations.xlsx'
input_combinations = pd.read_excel(input_combinations_path, sheet_name="Input_Output_Combination")

# Convert domain combinations to a list of sets for exact matching
exact_combinations = [set([row['Input'], row['Output']]) for _, row in input_combinations.iterrows()]
...
output_path = 'exact_output_IO_1_7.txt'
