...
output_combinations_path = 'Unique_Domain_Combinations.xlsx'
output_combinations = pd.read_excel(output_combinations_path, sheet_name="Output_Combination")

# Convert domain combinations to a list of sets for exact matching
exact_combinations = [set(row.dropna().tolist()) for _, row in output_combinations.iterrows()]
...
output_path = 'exact_output_O_1_7.txt'
